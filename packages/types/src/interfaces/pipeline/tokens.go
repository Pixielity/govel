...
const (
	...
	PIPELINE_FACTORY_TOKEN = "govel.pipeline.factory"

	// PIPELINE_MANAGER_TOKEN is the manager token for pipeline
	PIPELINE_MANAGER_TOKEN = "govel.pipeline.manager"

	// PIPELINE_INTERFACE_TOKEN is the interface token for pipeline
	PIPELINE_INTERFACE_TOKEN = "govel.pipeline.interface"

	// PIPELINE_CONFIG_TOKEN is the config token for pipeline
	PIPELINE_CONFIG_TOKEN = "govel.pipeline.config"

	// PIPELINE_HUB_TOKEN is the hub token for pipeline
	PIPELINE_HUB_TOKEN = "govel.pipeline.hub"
)
