...
import (
	interfaces "govel/types/interfaces/encryption"
...
func Crypt() interfaces.EncrypterInterface {
	...
	// - Resolves encryption service using type-safe token from the dependency injection container
	// - Performs type assertion to EncrypterInterface
...
func CryptWithError() (interfaces.EncrypterInterface, error) {
	...
	// - Thread-safe with optimized locking
	return facade.TryResolve[interfaces.EncrypterInterface](interfaces.ENCRYPTION_TOKEN)
}
